...
function createCarRecord(makeStr, modelStr, yearNum, licenseStr){
...
if(typeof makeStr === 'undefined' || typeof modelStr === 'undefined' || typeof licenseStr === 'undefined'){
  return 'new record must have make, model, year, and license values';
}

else if(typeof makeStr !== 'string' || typeof modelStr !== 'string' || typeof licenseStr !== 'string'){
  return '1st, 2nd, and 4th arguments must be String';
}

else if(typeof yearNum !== 'number'){
